...
export const SETTINGS_NAV: readonly SettingsNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'storyteller',
        routeName: 'settings-storyteller',
        labelKey: 'settings.integrations.tabs.storyteller',
        descriptionKey: 'settings.integrations.providerSubtitles.storyteller',
        icon: BookHeadphones,
        keywords: 'storyteller read-along readalong epub3 media overlay alignment narration',
        isVisible: anyPermission(Permission.ManageAppSettings),
      },
    ],
  },
