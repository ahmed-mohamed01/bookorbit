...
vi.mock('../../api/audiobookshelf.api', () => ({
  ...
  updateAudiobookshelfSettings: vi.fn(),
  disconnectAudiobookshelf: vi.fn(),
  testAudiobookshelfConnection: vi.fn(),
  fetchAudiobookshelfBookStates: vi.fn<() => Promise<AudiobookshelfBookStatePage>>(),
  confirmAudiobookshelfMatch: vi.fn(),
  linkAudiobookshelfBook: vi.fn(),
  unlinkAudiobookshelfBook: vi.fn(),
  updateAudiobookshelfBookExclusion: vi.fn(),
  rescanAudiobookshelfMatches: vi.fn(),
}))
