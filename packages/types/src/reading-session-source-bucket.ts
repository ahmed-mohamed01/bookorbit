...
export const READING_SESSION_SOURCE_BUCKETS = ["bookorbit", "ios", "watchos", "koreader", "kobo", "audiobookshelf"] as const;
...
// Native Apple clients remain distinct so device attribution survives aggregation.
...
export function emptySourceBucketRecord(): Record<ReadingSessionSourceBucket, number> {
  return { bookorbit: 0, ios: 0, watchos: 0, koreader: 0, kobo: 0, audiobookshelf: 0 };
}
